...
<div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
  New notes are up for ${escapeHtml(data.moduleTitle)} in ${escapeHtml(data.programName)}.
</div>
  ...
  <tr>
    <td class="fluid-padding" style="padding:36px 40px 0;">
      ...
      <div style="font-family:'DM Sans',Arial,sans-serif; font-size:14px; line-height:1.75; color:rgba(255,255,255,0.65);">
        Your teacher just uploaded notes for <strong style="color:#ffffff;">${escapeHtml(data.moduleTitle)}</strong>
        in <strong style="color:#ffffff;">${escapeHtml(data.programName)}</strong>. They're available in your dashboard now.
      </div>
    </td>
  </tr>
  ...
  <tr>
    <td class="fluid-padding" align="center" style="padding:30px 40px 0;">
      ...
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
        href="${contentUrl}" style="height:48px;v-text-anchor:middle;width:280px;" arcsize="50%" fillcolor="#3b5bdb" stroke="f">
        <w:anchorlock/>
        <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">Open Notes &rarr;</center>
      </v:roundrect>
      <![endif]-->
      <!--[if !mso]><!-->
      <a href="${contentUrl}" target="_blank" class="stack-button"
        ...
        <tr>
          <td style="padding-top:18px;">
            <div style="font-family:'DM Sans',Arial,sans-serif; font-size:11px; line-height:1.7; color:rgba(255,255,255,0.28);">
              You're receiving this email because you're enrolled in ${escapeHtml(data.programName)} on Tivra.<br>
