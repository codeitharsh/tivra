  ...
  <tr>
    <td class="fluid-padding" align="center" style="padding:30px 40px 0;">
      ...
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
        ...
        <w:anchorlock/>
        <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">View ${kindLabel === 'test' ? 'Tests' : 'Assessments'} &rarr;</center>
      </v:roundrect>
      <![endif]-->
      <!--[if !mso]><!-->
      <a href="${contentUrl}" target="_blank" class="stack-button"
        ...
        View ${kindLabel === 'test' ? 'Tests' : 'Assessments'} &rarr;
      </a>
      <!--<![endif]-->
    </td>
  </tr>
