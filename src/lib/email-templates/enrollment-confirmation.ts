...
// see that file's header comment for why (Outlook, Gmail, and most
// clients ignore <style> blocks and CSS gradients/flexbox).
// ════════════════════════════════════════════════════════════════
...
<div style="display:none; max-height:0; overflow:hidden; mso-hide:all;">
  Your payment is verified — ${escapeHtml(data.programName)} is unlocked in your dashboard.
</div>
  ...
  <tr>
    <td class="fluid-padding" style="padding:36px 40px 0;">
      ...
      <div style="font-family:'DM Sans',Arial,sans-serif; font-size:14px; line-height:1.75; color:rgba(255,255,255,0.65);">
        We've verified your payment of <strong style="color:#ffffff;">${amountLabel}</strong> and enrolled you in
        <strong style="color:#ffffff;">${escapeHtml(data.programName)}</strong>. Full access is unlocked right now.
      </div>
    </td>
  </tr>
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
          <td style="padding:22px 24px;">
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
              ${featureRow('🎥', 'Live weekly classes')}
              ${featureRow('📄', 'Study notes & recordings')}
              ${featureRow('📋', 'Weekly tests & assessments')}
              ${featureRow('💬', 'Doubt Corner support')}
              ${featureRow('🎓', 'Verified certificate on completion')}
            </table>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td class="fluid-padding" align="center" style="padding:30px 40px 0;">
      ...
      <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word"
        href="${dashboardUrl}" style="height:48px;v-text-anchor:middle;width:280px;" arcsize="50%" fillcolor="#3b5bdb" stroke="f">
        <w:anchorlock/>
        <center style="color:#ffffff;font-family:Arial,sans-serif;font-size:14px;font-weight:700;">Go to Dashboard &rarr;</center>
      </v:roundrect>
      <![endif]-->
      <!--[if !mso]><!-->
      <a href="${dashboardUrl}" target="_blank" class="stack-button"
        ...
        <tr>
          <td style="padding-top:18px;">
            <div style="font-family:'DM Sans',Arial,sans-serif; font-size:11px; line-height:1.7; color:rgba(255,255,255,0.28);">
              You're receiving this email because you enrolled in a programme on Tivra.<br>
